...
<body>
  ...
  <div class="row">
      <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xs-offset-3">
          <form id="contact-form" class="form" action="updateproduct.php" method="POST" role="form">
              ...
              <div class="form-group">
                  ...
                  <textarea rows="5" cols="50" name="description" class="form-control" id="message" placeholder="Write product description" tabindex="4" required></textarea>                                 
              </div>
